...
#----------------------------------------------------------------------------
  private
    ...
    def order_params
      params.require(:order).permit(:user_id, :order_date, :shipping_cost, ordereditems_attributes: [:id, :order_id, :sold_artwork_id, :quantity, :price, :category, :title, :imagepath, :description, :seller_name, :seller_email])
    end
end
